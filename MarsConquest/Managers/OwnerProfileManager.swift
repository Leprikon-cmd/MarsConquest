//
//  OwnerProfileManager.swift
//
//  Зачем:
//  Создаёт и читает единственный профиль владельца личного журнала.
//
//  Кто:
...
//  - состав «Моей коллекции» синхронизирован с OwnerProfile и GameExpansions;
//    новые дополнения нужно добавить в оба места и в резервный архив.
//
import CoreData
import Foundation
import UIKit
