...
//
//  Зачем:
//  Показывает значение очков и позволяет заменить его через цифровую клавиатуру.
//
//  Кто:
...
//  - размер текста, границы и цвет состояния ввода; правила проверки значения не относятся к оформлению.
//
