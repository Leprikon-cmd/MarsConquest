//
//  PlayerColorPickerView.swift
//
//  Зачем:
//  Показывает быстрый выбор цвета игрового кубика участника.
//
//  Кто:
...
//  - расстояние между кубиками и размеры отображения; доступные цвета задаёт GameData.swift.
//
import SwiftUI
