...
//
//  Зачем:
//  Вводит данные для последовательного разрешения ничьей за первое место.
//
//  Кто:
...
//  - подписи, интервалы и вид плашек; последовательность правил находится в ScoreManager.
//
