//
//  AddPlayerValidator.swift
//
//  Зачем:
//  Проверяет карточку игрока до добавления в текущую экспедицию.
//
//  Кто:
...
//  - тексты проверок и правила допуска; они должны совпадать с интерфейсом AddPlayerScreen.
//
import Foundation
