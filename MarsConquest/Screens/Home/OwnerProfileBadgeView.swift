//
//  OwnerProfileBadgeView.swift
//
//  Зачем:
//  Показывает личный бейдж владельца с аватаром и краткой статистикой.
//
//  Кто:
...
//  - фон, размеры, отступы и типографику карточки; стили аватаров задаются отдельно.
//
import SwiftUI
