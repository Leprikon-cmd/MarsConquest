//
//  HistoricalParticipationLinkView.swift
//
//  Зачем:
//  Позволяет владельцу вручную связать старые записи с его профилем.
//
//  Кто:
...
//  - тексты пояснений; правила привязки по имени требуют отдельной проверки исторических данных.
//
import CoreData
import SwiftUI
