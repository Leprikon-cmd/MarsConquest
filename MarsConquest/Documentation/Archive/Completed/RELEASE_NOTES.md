...
## Mars LogBook — «Надёжный журнал» / Reliable Logbook
...
- При импорте чужого архива владелец может явно указать себя среди внесённых участников;
  приложение не связывает историю по совпадению имени.
- Исторический импорт выполняется атомарно и сохраняет постоянные игровые ключи для устойчивой
  локализации записей.
- Нижний запас над постоянной навигацией iPhone вынесен в одно правило.
