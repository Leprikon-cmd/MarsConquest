//
//  OwnerAvatarStyle.swift
//
//  Зачем:
//  Перечисляет доступные стили личного аватара владельца журнала.
//
//  Кто:
...
//  - список встроенных образов и их ключи; для каждого ключа нужна картинка в Assets.
//
import Foundation
